...
def home():
    ...
    image = PhotoImage(file='head.png')
    image_label = Label(main_frame,
                        image=image)
    image_label.place(x=350, y=350)
